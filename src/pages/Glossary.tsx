...
const glossaryTerms = [
  ...
  {
    term: "Macro",
    definition: "Automated sequence of commands and functions written in VBA (Visual Basic for Applications).",
    example: "Alt+F11 to open VBA editor",
    category: "Automation",
  },
  {
    term: "Power Query",
    definition: "Excel's data transformation and preparation tool for importing, cleaning, and shaping data.",
    example: "Data > Get & Transform Data",
    category: "Data Management",
  },
  {
    term: "Power Pivot",
    definition: "Advanced data modeling tool for creating relationships between tables and handling large datasets.",
    example: "Millions of rows, data models",
    category: "Data Analysis",
  },
  {
    term: "Slicer",
    definition: "Visual filter control for PivotTables and Tables that allows easy filtering with buttons.",
    example: "Insert > Slicer",
    category: "Data Analysis",
  },
  {
    term: "Sparkline",
    definition: "Tiny chart in a single cell that provides a visual representation of data trends.",
    example: "Insert > Sparklines",
    category: "Visualization",
  },
  {
    term: "Freeze Panes",
    definition: "Feature that keeps specific rows or columns visible while scrolling through a worksheet.",
    example: "View > Freeze Panes",
    category: "Navigation",
  },
  {
    term: "Flash Fill",
    definition: "Automatic data pattern recognition that fills cells based on examples you provide.",
    example: "Data > Flash Fill or Ctrl+E",
    category: "Data Management",
  },
  {
    term: "Goal Seek",
    definition: "Tool that finds the input value needed to achieve a specific goal in a formula.",
    example: "Data > What-If Analysis > Goal Seek",
    category: "Analysis Tools",
  },
  {
    term: "Solver",
    definition: "Advanced optimization tool for finding the best solution given constraints and objectives.",
    example: "Data > Solver",
    category: "Analysis Tools",
  },
  {
    term: "Data Table",
    definition: "What-if analysis tool showing how changing variables affect formula results.",
    example: "One-variable or two-variable tables",
    category: "Analysis Tools",
  },
  {
    term: "Scenario Manager",
    definition: "Tool for creating and comparing different sets of values (scenarios) in your worksheet.",
    example: "Data > What-If Analysis > Scenario Manager",
    category: "Analysis Tools",
  },
  {
    term: "INDIRECT Reference",
    definition: "Dynamic cell reference created from text strings, useful for complex formulas.",
    example: "=INDIRECT(\"A\"&ROW())",
    category: "Formulas",
  },
  {
    term: "Defined Name",
    definition: "Custom name assigned to a cell, range, formula, or constant for easier reference.",
    example: "TotalSales, TaxRate",
    category: "References",
  },
  {
    term: "Structured Reference",
    definition: "Table-based reference style using column names instead of cell addresses.",
    example: "[@Sales] or Table1[Amount]",
    category: "References",
  },
  {
    term: "Error Value",
    definition: "Special values indicating formula or function errors in Excel.",
    example: "#N/A, #REF!, #DIV/0!, #VALUE!",
    category: "Errors",
  },
  {
    term: "Ribbon",
    definition: "The tabbed toolbar interface at the top of Excel containing commands and features.",
    example: "Home, Insert, Formulas tabs",
    category: "Interface",
  },
  {
    term: "Quick Access Toolbar",
    definition: "Customizable toolbar for frequently used commands, located above or below the ribbon.",
    example: "Save, Undo, Redo buttons",
    category: "Interface",
  },
  {
    term: "Formula Bar",
    definition: "The input area below the ribbon where you can view and edit cell contents and formulas.",
    example: "Shows =SUM(A1:A10)",
    category: "Interface",
  },
  {
    term: "Name Box",
    definition: "Box to the left of formula bar showing the active cell address or defined name.",
    example: "A1, Sales_Total",
    category: "Interface",
  },
  {
    term: "AutoFill",
    definition: "Feature that automatically fills cells with data patterns by dragging the fill handle.",
    example: "Drag corner of cell to copy/extend",
    category: "Data Entry",
  },
  {
    term: "Fill Handle",
    definition: "Small square at the bottom-right corner of a cell used for AutoFill operations.",
    example: "Drag to copy or extend data",
    category: "Data Entry",
  },
  {
    term: "Sheet Tab",
    definition: "Tab at the bottom of the workbook used to navigate between worksheets.",
    example: "Sheet1, Sheet2, Summary",
    category: "Navigation",
  },
  {
    term: "Cell Formatting",
    definition: "Applying styles, colors, borders, and number formats to cells.",
    example: "Ctrl+1 for Format Cells dialog",
    category: "Formatting",
  },
  {
    term: "Number Format",
    definition: "The way numbers are displayed (currency, percentage, date, etc.) without changing the actual value.",
    example: "1234.56 as $1,234.56 or 123,456%",
    category: "Formatting",
  },
  {
    term: "Custom Format",
    definition: "User-defined number format using format codes for specific display requirements.",
    example: "[Green]0.00;[Red]-0.00",
    category: "Formatting",
  }
];
