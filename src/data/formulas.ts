...
export const formulas: Formula[] = [
  ...
  // Additional Lookup & Reference Functions
  {
    id: 'address',
    name: 'ADDRESS',
    category: 'lookup-reference',
    description: 'Returns a cell reference as text',
    syntax: '=ADDRESS(row_num, column_num, [abs_num], [a1], [sheet_text])',
    example: '=ADDRESS(2, 3)',
    notes: 'Returns "$C$2". Creates a cell reference from row and column numbers.',
  },
  {
    id: 'areas',
    name: 'AREAS',
    ...
    example: '=AREAS((A1:C3,E5:F6))',
    notes: 'Returns 2. Counts the number of ranges in a reference.',
  },
  {
    id: 'formulatext',
    name: 'FORMULATEXT',
    category: 'lookup-reference',
    description: 'Returns a formula as text',
    syntax: '=FORMULATEXT(reference)',
    example: '=FORMULATEXT(A1)',
    notes: 'Returns the formula in A1 as a text string.',
  },
  {
    id: 'getpivotdata',
    name: 'GETPIVOTDATA',
    category: 'lookup-reference',
    description: 'Returns data from a PivotTable',
    syntax: '=GETPIVOTDATA(data_field, pivot_table, [field1, item1], ...)',
    example: '=GETPIVOTDATA("Sales", A3)',
    notes: 'Extracts specific data from a PivotTable.',
  },
  {
    id: 'hyperlink',
    name: 'HYPERLINK',
    ...
    notes: 'Creates a clickable link in a cell.',
  },
  ...
  // Additional Text Functions
  {
    ...
    syntax: '=CHAR(number)',
    example: '=CHAR(65)',
    notes: 'Returns "A". Uses ASCII/Unicode character codes.',
  },
  {
    id: 'code',
    name: 'CODE',
    ...
    syntax: '=CODE(text)',
    example: '=CODE("A")',
    notes: 'Returns 65. Returns the ASCII/Unicode value.',
  },
  {
    id: 'clean',
    name: 'CLEAN',
    ...
    syntax: '=CLEAN(text)',
    example: '=CLEAN(A1)',
    notes: 'Removes characters with ASCII values 0-31.',
  },
  {
    id: 'dollar',
    name: 'DOLLAR',
  ...
  // Additional Date & Time Functions
  {
    ...
    example: '=DATEVALUE("12/25/2024")',
    notes: 'Converts text date to Excel serial number.',
  },
  {
    id: 'timevalue',
    name: 'TIMEVALUE',
    ...
    notes: 'Converts text time to Excel time value.',
  },
  {
    id: 'yearfrac',
    name: 'YEARFRAC',
    ...
    example: '=YEARFRAC("1/1/2024", "12/31/2024")',
    notes: 'Returns approximately 1.0 for a full year.',
  },
  {
    id: 'isoweeknum',
    name: 'ISOWEEKNUM',
    ...
    notes: 'ISO 8601 week numbering system.',
  },

  // Additional Math & Trig Functions
  {
    id: 'exp',
    name: 'EXP',
    category: 'math-trig',
    ...
    syntax: '=EXP(number)',
    example: '=EXP(1)',
    notes: 'Returns 2.71828... (Euler\'s number).',
  },
  {
    id: 'ln',
    name: 'LN',
  ...
  },
  {
    ...
    example: '=LOG(100, 10)',
    notes: 'Returns 2. Default base is 10.',
  },
  {
    id: 'log10',
    name: 'LOG10',
  ...
  },
  {
    ...
    syntax: '=FACT(number)',
    example: '=FACT(5)',
    notes: 'Returns 120 (5×4×3×2×1).',
  },
  {
    id: 'sumproduct',
    name: 'SUMPRODUCT',
    category: 'math-trig',
    description: 'Multiplies corresponding components in arrays and returns the sum',
    syntax: '=SUMPRODUCT(array1, [array2], ...)',
    example: '=SUMPRODUCT(A1:A5, B1:B5)',
    notes: 'Multiplies each pair and sums the results.',
  },
  {
    id: 'sumsq',
    name: 'SUMSQ',
    category: 'math-trig',
    description: 'Returns the sum of the squares of arguments',
    syntax: '=SUMSQ(number1, [number2], ...)',
    example: '=SUMSQ(3, 4)',
    notes: 'Returns 25 (9+16).',
  },
  {
    id: 'quotient',
    name: 'QUOTIENT',
    ...
    notes: 'Returns 3 (ignores remainder).',
  },
  {
    id: 'mround',
    name: 'MROUND',
  ...
  },
  {
    ...
    name: 'ATAN2',
    category: 'math-trig',
    description: 'Returns the arctangent of x and y coordinates',
  ...
  },
  {
    ...
    notes: 'Function_num: 1=AVERAGE, 2=COUNT, 4=MAX, 5=MIN, 9=SUM, etc.',
  },
  {
    id: 'subtotal',
    name: 'SUBTOTAL',
    ...
    notes: 'Function_num: 1=AVERAGE, 2=COUNT, 9=SUM, etc. Ignores hidden rows.',
  },
  ...
  },
  {
    ...
    notes: 'Excludes 20% of data (10% from each end).',
  },
  {
    id: 'avedev',
    name: 'AVEDEV',
    category: 'statistical',
    description: 'Returns the average of the absolute deviations',
    syntax: '=AVEDEV(number1, [number2], ...)',
    example: '=AVEDEV(1, 2, 3, 4, 5)',
    notes: 'Measures variability in a dataset.',
  },
  {
    id: 'devsq',
    name: 'DEVSQ',
    ...
    notes: 'Measures spread around the mean.',
  },
  {
    id: 'frequency',
    name: 'FREQUENCY',
    category: 'statistical',
    description: 'Returns a frequency distribution as an array',
    syntax: '=FREQUENCY(data_array, bins_array)',
    example: '=FREQUENCY(A1:A10, C1:C5)',
    notes: 'Array formula that counts values in bins.',
  },
  {
    id: 'correl',
    name: 'CORREL',
    ...
    notes: 'Returns value between -1 and 1.',
  },
  {
    id: 'covariance',
    name: 'COVARIANCE.P',
    ...
    notes: 'Measures how two variables vary together.',
  },
  {
    id: 'forecast',
    name: 'FORECAST',
    category: 'statistical',
    description: 'Predicts a future value based on existing values',
    syntax: '=FORECAST(x, known_y\'s, known_x\'s)',
    example: '=FORECAST(30, A1:A10, B1:B10)',
    notes: 'Linear trend forecasting.',
  },
  {
    id: 'slope',
    name: 'SLOPE',
    ...
    notes: 'Calculates rate of change.',
  },
  {
    id: 'intercept',
    name: 'INTERCEPT',
    ...
    notes: 'Where line crosses y-axis.',
  },
  {
    id: 'rsq',
    name: 'RSQ',
    ...
    notes: 'R-squared value, measures fit quality.',
  },
  {
    id: 'prob',
    name: 'PROB',
    category: 'statistical',
    description: 'Returns the probability that values in a range are between limits',
    syntax: '=PROB(x_range, prob_range, [lower_limit], [upper_limit])',
    example: '=PROB(A1:A5, B1:B5, 2, 4)',
    notes: 'Calculates probability for discrete distribution.',
  },
  {
    id: 'standardize',
    name: 'STANDARDIZE',
  ...
  },
  {
    ...
    example: '=SKEW(A1:A10)',
    notes: 'Measures asymmetry of distribution.',
  },
  {
    id: 'kurt',
    name: 'KURT',
    ...
    example: '=KURT(A1:A10)',
    notes: 'Measures tailedness of distribution.',
  },
  ...
  // Additional Financial Functions
  {
    ...
    name: 'IPMT',
    category: 'financial',
    description: 'Returns the interest payment for a given period',
    syntax: '=IPMT(rate, per, nper, pv, [fv], [type])',
    example: '=IPMT(10%/12, 1, 36, 8000)',
    notes: 'Interest portion of a loan payment.',
  },
  {
    id: 'ppmt',
    name: 'PPMT',
    category: 'financial',
    description: 'Returns the principal payment for a given period',
    syntax: '=PPMT(rate, per, nper, pv, [fv], [type])',
    example: '=PPMT(10%/12, 1, 36, 8000)',
    notes: 'Principal portion of a loan payment.',
  },
  {
    id: 'cumipmt',
    name: 'CUMIPMT',
    ...
    example: '=CUMIPMT(9%/12, 30*12, 125000, 1, 12, 0)',
    notes: 'Total interest paid over time range.',
  },
  {
    id: 'cumprinc',
    name: 'CUMPRINC',
    ...
    example: '=CUMPRINC(9%/12, 30*12, 125000, 1, 12, 0)',
    notes: 'Total principal paid over time range.',
  },
  {
    id: 'xnpv',
    name: 'XNPV',
    ...
    notes: 'NPV for irregular payment dates.',
  },
  {
    id: 'xirr',
    name: 'XIRR',
    ...
    notes: 'IRR for irregular payment dates.',
  },
  {
    id: 'effect',
    name: 'EFFECT',
    ...
    example: '=EFFECT(5%, 12)',
    notes: 'Converts nominal to effective rate.',
  },
  {
    id: 'nominal',
    name: 'NOMINAL',
    ...
    example: '=NOMINAL(5%, 12)',
    notes: 'Converts effective to nominal rate.',
  },
  ...
  // Additional Information Functions
  {
    ...
    syntax: '=ISREF(value)',
    example: '=ISREF(A1)',
    notes: 'Checks if argument is a cell reference.',
  },
  {
    id: 'isnontext',
    name: 'ISNONTEXT',
    ...
    example: '=ISNONTEXT(100)',
    notes: 'Returns TRUE for numbers, FALSE for text.',
  },
  {
    id: 'isformula',
    name: 'ISFORMULA',
    ...
    notes: 'Checks if cell contains a formula.',
  },
  {
    id: 'sheet',
    name: 'SHEET',
    category: 'information',
    description: 'Returns the sheet number of the reference',
    syntax: '=SHEET([value])',
    example: '=SHEET(Sheet2!A1)',
    notes: 'Returns sheet index number.',
  },
  {
    id: 'sheets',
    name: 'SHEETS',
    ...
    example: '=SHEETS(Sheet1:Sheet3!A1)',
    notes: 'Counts sheets in reference.',
  },
  {
    id: 'info',
    name: 'INFO',
    ...
    example: '=INFO("system")',
    notes: 'Types: "directory", "numfile", "osversion", "release", etc.',
  },
  ...
  // Additional Engineering Functions
  {
    ...
    syntax: '=BESSELI(x, n)',
    example: '=BESSELI(1.5, 1)',
    notes: 'Engineering function for Bessel calculations.',
  },
  {
    id: 'besselj',
    name: 'BESSELJ',
  ...
  },
  {
    ...
    example: '=ERF(1)',
    notes: 'Error function for statistical calculations.',
  },
  {
    id: 'erfc',
    name: 'ERFC',
    ...
    syntax: '=ERFC(x)',
    example: '=ERFC(1)',
    notes: 'Complement of ERF function.',
  },
  {
    id: 'complex',
    name: 'COMPLEX',
